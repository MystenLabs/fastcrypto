...
mod p256_benches {
    ...
    fn add(c: &mut Criterion) {
        ...
        // eccoxide
        let x = eccoxide::curve::sec2::p256r1::FieldElement::from_slice(&Hex::decode("6B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C296").unwrap()).unwrap();
        let y = eccoxide::curve::sec2::p256r1::FieldElement::from_slice(&Hex::decode("4FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5").unwrap()).unwrap();
        ...
        let x = eccoxide::curve::sec2::p256r1::FieldElement::from_slice(&Hex::decode("7CF27B188D034F7E8A52380304B51AC3C08969E277F21B35A60B48FC47669978").unwrap()).unwrap();
        let y = eccoxide::curve::sec2::p256r1::FieldElement::from_slice(&Hex::decode("07775510DB8ED040293D9AC69F7430DBBA7DADE63CE982299E04B79D227873D1").unwrap()).unwrap();
        ...
        // arkworks
        let x = ark_secp256r1::Fq::from_be_bytes_mod_order(&Hex::decode("6B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C296").unwrap());
        let y = ark_secp256r1::Fq::from_be_bytes_mod_order(&Hex::decode("4FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5").unwrap());
        let p = ark_secp256r1::Affine::new(x, y);

        let x = ark_secp256r1::Fq::from_be_bytes_mod_order(&Hex::decode("7CF27B188D034F7E8A52380304B51AC3C08969E277F21B35A60B48FC47669978").unwrap());
        let y = ark_secp256r1::Fq::from_be_bytes_mod_order(&Hex::decode("07775510DB8ED040293D9AC69F7430DBBA7DADE63CE982299E04B79D227873D1").unwrap());
