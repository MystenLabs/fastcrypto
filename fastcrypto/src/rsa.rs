...
use base64ct::{Base64Url, Base64UrlUnpadded, Encoding as OtherEncoding};
use k256::ecdsa::Signature;
use rsa::pkcs1::pem::Base64Decoder;
...
fn jwt_test() {
    ...
    assert!(pk
        .verify_prehash(Sha256::digest(msg.as_slice()).as_ref(), &signature)
        .is_ok());
}

// TODO: Fails at test case with short signature
// #[test]
// fn wycheproof_test() {
