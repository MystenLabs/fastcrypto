...
impl From<&Ed25519AggregateSignature> for Ed25519AggregateSignatureAsBytes {
    fn from(sig: &Ed25519AggregateSignature) -> Self {
        Self(sig.as_bytes().to_vec())
    }
}

impl TryFrom<&Ed25519AggregateSignatureAsBytes> for Ed25519AggregateSignature {
