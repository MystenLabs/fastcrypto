...
mod tests {
    ...
    fn test_prove_and_verify() {
        ...
        // Regression tests
        assert_eq!(bcs::to_bytes(&output).unwrap(), hex::decode("002024ff799e22587cc344b83ace4ce2d814d52aba7dd711591fd407e31a55822a1e0020051fa84e09b4bd5a6ee02b6fae24db625863ae31cfaf962f2f490d92dd372e3f").unwrap());
        assert_eq!(bcs::to_bytes(&proof).unwrap(), hex::decode("00201c51f96394af8f5aa29a6f954b08e892c12a7382d5149dbf77b872320c0babc40020eb95792dcc7b7f1af1b3c009860ebd1af0a8e4f0952489bb9b36af19d5b36b25").unwrap());
