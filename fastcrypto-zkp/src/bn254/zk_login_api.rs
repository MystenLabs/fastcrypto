...
fn insecure_pvk() -> PreparedVerifyingKey<Bn254> {
    ...
    let vk_alpha_1 = g1_affine_from_str_projective(&vec![
        Bn254FqElement::from_str(
            "16853457964693368646114638082436217363607759612736879597454707797476117821030",
        )
        .unwrap(),
        Bn254FqElement::from_str(
            "6891326756227290982136260813454308117789055733665536861612191210781748498591",
        )
        .unwrap(),
    ...
    let vk_beta_2 = g2_affine_from_str_projective(&vec![
        vec![
            Bn254FqElement::from_str(
                "8517716783152056450383980110454539074775188178088361726140126779960892393418",
            )
            .unwrap(),
            Bn254FqElement::from_str(
                "8043610462256026603571563568819917166709129648854741230297468519005153950465",
            )
            .unwrap(),
        ],
        vec![
            Bn254FqElement::from_str(
                "20320542731011496311479192247394432661957713607366584194182804527945293569773",
            )
            .unwrap(),
            Bn254FqElement::from_str(
                "21640934911884701607478171172019265790555106946558172713061463107267785925202",
            )
            .unwrap(),
        ],
        vec![
    ...
    let vk_delta_2 = g2_affine_from_str_projective(&vec![
        vec![
            Bn254FqElement::from_str(
                "6089321758798653107859947879844393881156878275759131475050611487553191748235",
            )
            .unwrap(),
            Bn254FqElement::from_str(
                "3886636366857334762943939176171186910090184329937466786992354075736444582744",
            )
            .unwrap(),
        ],
        vec![
            Bn254FqElement::from_str(
                "1271118819661684073707504584447249939398031809042444113327306460595058400371",
            )
            .unwrap(),
            Bn254FqElement::from_str(
                "20943152196996836681509134409791546583251182655833130321802175385638615882657",
            )
            .unwrap(),
        ],
        vec![
    ...
    for e in [
        vec![
            Bn254FqElement::from_str(
                "1767227143293561823069397574393274407691811369713668332444640560142831659047",
            )
            .unwrap(),
            Bn254FqElement::from_str(
                "11497283407747921479654565616739511154899010521696061657418235125647115508955",
            )
            .unwrap(),
            Bn254FqElement::from_str("1").unwrap(),
        ],
        vec![
            Bn254FqElement::from_str(
                "3953939682302151485963771594528533577625444295246387391690871475195163706515",
            )
            .unwrap(),
            Bn254FqElement::from_str(
                "20011820598826080254708696961865046080952819495955142135085062032337973934705",
            )
            .unwrap(),
            Bn254FqElement::from_str("1").unwrap(),
        ],
