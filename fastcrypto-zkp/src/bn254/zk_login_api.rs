...
fn random_pvk() -> PreparedVerifyingKey<Bn254> {
    ...
    let vk_delta_2 = g2_affine_from_str_projective(vec![
        vec![
            "77314632849962708480389437811947203515945304615585645293854273303982004556"
                .to_string(),
            "1748191523519506843643902357176505840687054912260375882405667381787318001149"
                .to_string(),
        ],
        vec![
            "2478052866124445398103942180781133830692368826147772400840367821540788147639"
                .to_string(),
            "4317644698462350683163475513471968593273385377234755001391162743237415145040"
                .to_string(),
        ],
        vec!["1".to_string(), "0".to_string()],
    ])
