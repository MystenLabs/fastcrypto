...
//     prf::blake2s::Blake2s as B2SPRF, prf::blake2s::constraints::Blake2sGadget,
// };
// use ark_groth16::Groth16;
// use ark_relations::r1cs::{
//     ConstraintSynthesizer, ConstraintSystem, ConstraintSystemRef, SynthesisError,
// };
// use blake2::{Blake2s256, digest::Digest};
//
// use ark_r1cs_std::prelude::*;
// use ark_serialize::CanonicalSerialize;
// use ark_std::rand::thread_rng;
// use fastcrypto::groups::bls12381::{Scalar, SCALAR_LENGTH};
// use fastcrypto_zkp::bls12381::{PreparedVerifyingKey, Proof};
//
...
//     let inputs: Vec<Scalar> = [&scalar_from_arkworks(circuit.blake2_seed[..]), &circuit.expected_output[..]]
//         .iter()
