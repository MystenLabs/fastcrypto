...
/// XXH3. Note that this is NOT a cryptographic hash function and should NOT be used for cryptographic purposes in production.
...
/// XXH128. Note that this is NOT a cryptographic hash function and should NOT be used for cryptographic purposes in production.
#[cfg(feature = "unsafe_schemes")]
#[derive(Default)]
pub struct XXH128 {
    instance: xxhash_rust::xxh3::Xxh3,
